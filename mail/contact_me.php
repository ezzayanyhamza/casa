<?php
 ...
 $mail->isSMTP();
 $mail->SMTPAuth = true;
 $mail->SetFrom('noreply@yourdomain.com','User');
...
// Create the email and send the message
 ...
 $to = 'hamzaziyani590@gmail.com'; // Add your email address inbetween the '' replacing yourname@yourdomain.com - This is where the form will send a message to.
